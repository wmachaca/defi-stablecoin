...
contract MockMoreDebtDSC is ERC20Burnable, Ownable {
    ...
    */
    ...
    function burn(uint256 _amount) public override onlyOwner {
        // We crash the price
        MockV3Aggregator(mockAggregator).updateAnswer(1); // store price feed; ETH price = $0, before the burn happens.
        uint256 balance = balanceOf(msg.sender); // DSCEngine DSC balance.
        if (_amount <= 0) {
